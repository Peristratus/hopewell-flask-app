...
Social Media | H-1.4| Gain access to Medstar website | **As a** user **I want** to access home page   **so that** I can have access to the social media section.| **Given**  that the user is on MedStar home page, **When** they click on the contact us button **then** the system will take the user to the contact us page |    M   |
