...
Get Started btn | H-1.1| Gain access to Medstar website | **As a** user **I want** to access web page   **so that** I can have access to the get started button.| **Given**  that the user is on MedStar web web page, **When** they click on the get started button **then** the system will take the user to the user login/ register page |    M   |
Contact us btn | H-1.2| Gain access to Medstar website | **As a** user **I want** to access web page   **so that** I can have access to the contact us button.| **Given**  that the user is on MedStar web web page, **When** they click on the contact us button **then** the system will take the user to the contact us page |    M   |
