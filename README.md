...
Login/Register | LR-7.0 | Gain access to Medistar website | **As a** user **I want** to access the Login/Register Btn **so that** I can gain acesss to the Login/Register form.| **Given** that the user is on the medi web page, **When** they click on the login/register btn**then** the system will give the user access to the Login/Register page and form. |    M   |
